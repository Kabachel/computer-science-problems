...
public class TestFibonacci {
    ...
    public void testFibonacciSequenceRecursion() {
        ...
        Assert.assertEquals("fibRecursive(20)", 6765, Fibonacci.fibonacciSequenceRecursion(20));
    }
    ...
    public void testFibonacciSequenceMemoize() {
        ...
        Assert.assertEquals("fibMemoize(20)", 6765, Fibonacci.fibonacciSequenceMemoize(20));
    }
    ...
    public void testFibonacciSequenceIterative() {
        ...
        Assert.assertEquals("fibIterative(20)", 6765, Fibonacci.fibonacciSequenceIterative(20));
    }
    ...
    public void testFibonacciSequenceStream() {
        ...
        Assert.assertEquals("fibStream(20)", 6765, Fibonacci.fibonacciSequenceStream(20));
    }

    @Test
    public void testFibonacciSequenceBinet() {
        Assert.assertEquals("fibBinet(1)", 1, Fibonacci.fibonacciSequenceBinet(1));
        Assert.assertEquals("fibBinet(2)", 1, Fibonacci.fibonacciSequenceBinet(2));
        Assert.assertEquals("fibBinet(5)", 5, Fibonacci.fibonacciSequenceBinet(5));
        Assert.assertEquals("fibBinet(10)", 55, Fibonacci.fibonacciSequenceBinet(10));
        Assert.assertEquals("fibBinet(20)", 6765, Fibonacci.fibonacciSequenceBinet(20));
